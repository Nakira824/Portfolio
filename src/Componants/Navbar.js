...
<nav className='fixed w-full z-20 top-0 bg-orange-100 bg-opacity-80'>
    <div className=' max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2'>
        <img src='https://cdn3.iconfinder.com/data/icons/web-design-and-development-glyph-vol-1/64/web-development-glyph-05-512.png' className=' h-8 ml-4' alt='LOGO'/>
...
<div className={` item-center justify-between w-full md:flex md:w-auto md:order-1 ${
    isOpen? "block" : "hidden"} `}>
<ul className={` flex flex-col p-4 md:p-0 mt-4 text-xl border cursor-pointer border-gray-100 rounded-lg md:flex-row 
